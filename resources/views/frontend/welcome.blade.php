...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="assets/img/Newprofile-img.jpg" alt="" class="img-fluid rounded-circle">
        <h1 class="text-light"><a href="#">Muhammad Aalyan</a></h1>
        <div class="social-links mt-3 text-center">
          <a href="tel:{{ $data->email }}" class="twitter"><i class="bx bxl-twitter"></i></a>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>Muhammad Aalyan</h1>
      <p>I'm <span class="typed" data-typed-items=" a Laravel Developer, a Freelancer, a Leader"></span></p>
    </div>
  </section>
<!-- End Hero -->
        ...
        <div class="container">
          ...
          <div class="row" data-aos="fade-in">
            ...
            <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
              <form action="{{ url('/form-post') }}" method="post" role="form">
                @csrf
                <div class="row">
